...
use bevy::{
    ...
    render::{
        ...
        render_resource::{
            ...
            BufferBindingType, BufferInitDescriptor, BufferUsages, CachedPipelineState,
        ...
        view::{
            ExtractedView, ViewUniform, ViewUniformOffset, ViewUniforms, VisibilityClass,
    ...
    fn build(&self, app: &mut App) {
        ...
        render_app.add_systems(
            ...
            (
                ...
                prepare_atom_buffers.in_set(RenderSet::PrepareResources),
                prepare_bond_buffers.in_set(RenderSet::PrepareResources),
                // Bind group systems
                prepare_atom_uniforms_bind_group.in_set(RenderSet::PrepareBindGroups),
                prepare_bond_uniforms_bind_group.in_set(RenderSet::PrepareBindGroups),
                // Queue rendering
                queue_molecule_draw_commands.in_set(RenderSet::Queue),
            ),
        );
    }
...
trait MoleculeRenderPipeline {
    fn new(shader: Handle<Shader>, bind_group_layout: BindGroupLayout) -> Self;
...
fn render_pipeline_from_world<T: MoleculeRenderPipeline>(
    ...
    let bind_group_layout = render_device.create_bind_group_layout(
        format!("{}_pipeline_bind_group_layout", name).as_str(),
        &[
