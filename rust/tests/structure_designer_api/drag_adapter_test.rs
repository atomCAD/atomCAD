...
use atomcad_structure_designer::node_data::{DragDirection, NodeData};
...
use atomcad_structure_designer::structure_designer::{DragSource, StructureDesigner};
use glam::f64::DVec2;
...
fn adapt_expr(source: DataType, dir: DragDirection) -> Option<ExprData> {
    ...
    let data = (atomcad_structure_designer::nodes::expr::get_node_type().node_data_creator)();
    let adapted = data.adapt_for_drag_source(&source, dir, &registry)?;
