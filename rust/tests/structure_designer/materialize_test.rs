...
/// `invert_phase`, `rm_unbonded`, `regions`, `passiv_elem` — no `motif` or
/// `m_offset` pins. (`regions` added by
/// `doc/design_blueprint_region_atom_edits.md` Phase B2; `passiv_elem` by
/// `doc/design_halogen_passivation.md` Phase 2.)
#[test]
