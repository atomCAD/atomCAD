...
fn test_new_with_unordered_corners() {
    let box1 = DAABox::new(DVec3::new(10.0, 20.0, 30.0), DVec3::new(5.0, 15.0, 25.0));
...
fn test_from_start_and_size_negative() {
    let box1 =
        DAABox::from_start_and_size(DVec3::new(10.0, 10.0, 10.0), DVec3::new(-5.0, 5.0, -3.0));
...
#[test]
fn test_overlaps() {
    let box1 = DAABox::from_min_max(DVec3::new(0.0, 0.0, 0.0), DVec3::new(10.0, 10.0, 10.0));

    let box2 = DAABox::from_min_max(DVec3::new(5.0, 5.0, 5.0), DVec3::new(15.0, 15.0, 15.0));
...
#[test]
fn test_no_overlap() {
    let box1 = DAABox::from_min_max(DVec3::new(0.0, 0.0, 0.0), DVec3::new(5.0, 5.0, 5.0));

    let box2 = DAABox::from_min_max(DVec3::new(10.0, 10.0, 10.0), DVec3::new(15.0, 15.0, 15.0));
...
fn test_conservative_overlap() {
    ...
    let box2 = DAABox::from_min_max(DVec3::new(5.1, 5.1, 5.1), DVec3::new(10.0, 10.0, 10.0));
...
#[test]
fn test_expand() {
    let box1 = DAABox::from_min_max(DVec3::new(5.0, 5.0, 5.0), DVec3::new(10.0, 10.0, 10.0));
