use atomcad_crystolecule::io::cif::space_groups::{
...
fn sg227_diamond_expansion() {
    use atomcad_crystolecule::io::cif::symmetry::{CifAtomSite, expand_asymmetric_unit};
    use glam::DVec3;
...
fn load_cif_with_space_group_number_only() {
    use atomcad_crystolecule::io::cif::load_cif_from_str;
