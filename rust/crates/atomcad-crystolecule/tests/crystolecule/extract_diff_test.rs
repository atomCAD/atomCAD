...
use atomcad_crystolecule::atomic_structure_diff::{apply_diff, compose_two_diffs, extract_diff};
use glam::f64::DVec3;
...
fn only_atom(diff: &AtomicStructure) -> &atomcad_crystolecule::atomic_structure::Atom {
