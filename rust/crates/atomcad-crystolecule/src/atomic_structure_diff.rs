...
use crate::atomic_structure::DELETED_SITE_ATOMIC_NUMBER;
use crate::atomic_structure::UNCHANGED_ATOMIC_NUMBER;
use crate::atomic_structure::atom::Atom;
use crate::atomic_structure::atom::DURABLE_FLAGS_MASK;
use crate::atomic_structure::inline_bond::BOND_DELETED;
use glam::f64::DVec3;
            ...
            if diff1_is_unchanged {
                ...
                if diff2_is_modify {
                    ...
                    let cid = composed.add_atom(
                        crate::atomic_structure::DELETED_SITE_ATOMIC_NUMBER,
                        match_pos,
                    );
                    composed.set_anchor_position(cid, match_pos);
                    diff1_to_composed.insert(diff1_atom.id, cid);
