...
use crate::atomic_structure::{Atom, AtomicStructure, BondReference};
use crate::atomic_structure_utils::remove_single_bond_atoms;
use crate::crystolecule_constants::{
    DEFAULT_ZINCBLENDE_MOTIF, DIAMOND_UNIT_CELL_SIZE_ANGSTROM, ZINCBLENDE_SITE_CORNER,
    ZINCBLENDE_SITE_FACE_X, ZINCBLENDE_SITE_FACE_Y, ZINCBLENDE_SITE_FACE_Z,
    ZINCBLENDE_SITE_INTERIOR1, ZINCBLENDE_SITE_INTERIOR2, ZINCBLENDE_SITE_INTERIOR3,
    ZINCBLENDE_SITE_INTERIOR4,
};
use crate::lattice_fill::config::SettingsResolver;
use crate::lattice_fill::placed_atom_tracker::{CrystallographicAddress, PlacedAtomTracker};
...
fn apply_dimer_reconstruction(
    ...
    let new_pos1 =
        pos1 + in_plane_direction * move_distance + surface_normal * vertical_displacement;
    let new_pos2 =
        pos2 - in_plane_direction * move_distance + surface_normal * vertical_displacement;
