...
use crate::evaluator::network_result::{CrystalData, NetworkResult};
...
impl NodeData for MaterializeData {
    ...
    /// Non-blocking: `eval` never consults `self.error` — an unparsed parameter
    /// element definition simply leaves `parameter_element_values` empty and
