use crate::node_network::NodeDisplayType;
use crate::node_network::NodeNetwork;
use crate::preferences::{NodeDisplayPolicy, NodeDisplayPreferences};
...
impl NodeDisplayPolicyResolver {
    ...
    pub fn resolve(
        ...
        let islands =
            self.find_islands_with_dirty_nodes(node_network, all_nodes, &reverse_connections);
        ...
        for island in islands {
            match node_display_preferences.display_policy {
                ...
                NodeDisplayPolicy::PreferSelected => {
                    let selected_in_island = node_network
                        .active_node_id
                    ...
                    if let Some(selected_id) = selected_in_island {
                        ...
                        for &node_id in &island {
                            ...
                            self.add_display_change_if_needed(
                                node_network,
                                node_id,
                                new_display,
                                &mut changes,
