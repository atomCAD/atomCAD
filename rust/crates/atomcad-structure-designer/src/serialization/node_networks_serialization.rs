...
fn category_to_string(category: &crate::node_type::NodeTypeCategory) -> String {
...
fn category_from_string(category_str: &str) -> crate::node_type::NodeTypeCategory {
    use crate::node_type::NodeTypeCategory;
    match category_str {
...
fn default_body_width() -> f64 {
    crate::node_network::DEFAULT_BODY_WIDTH
}

fn default_body_height() -> f64 {
    crate::node_network::DEFAULT_BODY_HEIGHT
}
...
pub fn load_node_networks_from_file(
    ...
    crate::canonicalize::canonicalize_record_type_defs(&mut registry.record_type_defs);
