...
fn create_standard_function_implementations() -> HashMap<String, EvaluationFunction> {
        ...
        Box::new(|args: &[NetworkResult]| {
            if args.len() != 1 {
                return NetworkResult::Error(
                    "normalize2() requires exactly 1 argument".to_string(),
                );
            }
            match &args[0] {
    ...
    functions.insert(
        ...
        Box::new(|args: &[NetworkResult]| {
            if args.len() != 1 {
                return NetworkResult::Error(
                    "normalize3() requires exactly 1 argument".to_string(),
                );
            }
            match &args[0] {
    ...
    functions.insert(
        ...
        Box::new(|args: &[NetworkResult]| {
            if args.len() != 2 {
                return NetworkResult::Error(
                    "distance2() requires exactly 2 arguments".to_string(),
                );
            }
            match (&args[0], &args[1]) {
                (NetworkResult::Vec2(a), NetworkResult::Vec2(b)) => {
                    NetworkResult::Float((*a - *b).length())
                }
    ...
    functions.insert(
        ...
        Box::new(|args: &[NetworkResult]| {
            if args.len() != 2 {
                return NetworkResult::Error(
                    "distance3() requires exactly 2 arguments".to_string(),
                );
            }
            match (&args[0], &args[1]) {
                (NetworkResult::Vec3(a), NetworkResult::Vec3(b)) => {
    ...
    functions.insert(
        ...
        Box::new(|args: &[NetworkResult]| {
            ...
            NetworkResult::Mat3(crate::evaluator::network_result::rows_to_dmat3(&rows))
        }) as EvaluationFunction,
    );
    ...
    functions.insert(
        ...
        Box::new(|args: &[NetworkResult]| {
            ...
            match &args[0] {
                NetworkResult::IMat3(m) => {
                    NetworkResult::Mat3(crate::evaluator::network_result::imat3_rows_to_dmat3(m))
                }
        ...
        Box::new(|args: &[NetworkResult]| {
            ...
            match &args[0] {
                NetworkResult::Mat3(m) => {
                    ...
                    let rows = crate::evaluator::network_result::dmat3_to_rows(m);
                    let t = [
