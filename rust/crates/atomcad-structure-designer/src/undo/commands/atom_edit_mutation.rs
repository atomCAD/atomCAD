...
use crate::nodes::atom_edit::diff_recorder::{AtomDelta, BondDelta, CrossCellBondDelta};
...
fn get_atom_edit_data_mut<'a>(
    ...
    network_name: &str,
    node_id: u64,
) -> Option<&'a mut crate::nodes::atom_edit::atom_edit::AtomEditData> {
...
fn apply_undo(
    data: &mut crate::nodes::atom_edit::atom_edit::AtomEditData,
