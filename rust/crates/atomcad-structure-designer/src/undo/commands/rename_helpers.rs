use crate::eval_errors::EvalErrorEntry;
...
pub fn apply_rename_core(
    ...
    crate::eval_errors::rewrite_network_name_in_snapshots(eval_error_snapshots, old_name, new_name);
