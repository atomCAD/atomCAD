use crate::node_network::{NodeDisplayState, NodeDisplayType};
use crate::undo::snapshot::{NodeSnapshot, WireSnapshot};
...
impl PasteNodesCommand {
    fn restore_nodes(&self, ctx: &mut UndoContext) {
        ...
        let node_data_vec: Vec<Option<Box<dyn crate::node_data::NodeData>>> = self
            .pasted_nodes
            .iter()
            .map(|snap| {
        ...
        let zone_bodies: Vec<Option<crate::node_network::NodeNetwork>> = self
            .pasted_nodes
            .iter()
