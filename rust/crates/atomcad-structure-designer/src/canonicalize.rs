...
//!
//! 1. [`FunctionType::new`](crate::data_type::FunctionType::new)
...
//! [`walk_all_nodes_mut`](crate::node_network::walk_all_nodes_mut),
//! so body-internal node-data DataType fields are covered the same way as
//! top-level ones.

use std::collections::HashMap;

use crate::data_type::canonicalize_data_type;
use crate::node_data::NodeData;
use crate::node_network::{NodeNetwork, walk_all_nodes_mut};
use crate::node_type::{NodeType, PinOutputType};
use crate::node_type_registry::RecordTypeDef;
...
fn canonicalize_node_data(data: &mut dyn NodeData) {
    ...
    } else if let Some(d) = any.downcast_mut::<SwitchData>() {
        canonicalize_data_type(&mut d.selector_type);
        canonicalize_data_type(&mut d.value_type);
    }
