...
#[path = "structure_designer/mechanosynth_trajectory_node_test.rs"]
mod mechanosynth_trajectory_node_test;
...
#[path = "structure_designer/ai_activity_log_test.rs"]
mod ai_activity_log_test;
