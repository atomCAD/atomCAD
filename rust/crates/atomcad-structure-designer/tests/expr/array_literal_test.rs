...
use atomcad_structure_designer::expr::expr::Expr;
use atomcad_structure_designer::expr::lexer::{Token, tokenize};
use atomcad_structure_designer::expr::parser::{parse, parse_concrete_type_name};
use atomcad_structure_designer::expr::validation::{
    ...
    fn test_parse_unknown_type_after_empty_marker() {
        ...
        match expr {
            Expr::EmptyArray(DataType::Record(rec)) => match rec {
                atomcad_structure_designer::data_type::RecordType::Named(n) => {
                    assert_eq!(n, "Foo");
                }
...
mod element_type_eligibility_tests {
    ...
    fn every_concrete_datatype_is_array_eligible_or_explicitly_rejected() {
        ...
        let variants: Vec<DataType> = vec![
            ...
            DataType::Function(atomcad_structure_designer::data_type::FunctionType {
            ...
            DataType::Record(
                atomcad_structure_designer::data_type::RecordType::anonymous(vec![(
                    "x".to_string(),
                    DataType::Int,
                )]),
            ),
