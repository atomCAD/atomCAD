...
use atomcad_structure_designer::node_network::{IncomingWire, Node, NodeNetwork};
use atomcad_structure_designer::node_type::{NodeType, Parameter};
use atomcad_structure_designer::node_type_registry::RecordTypeDef;
use atomcad_structure_designer::nodes::closure::ClosureData;
...
fn named_refs(dt: &DataType, out: &mut Vec<String>) {
    use atomcad_structure_designer::data_type::walk_data_type_record_names_mut;
