...
mod serializer_tests {
    use super::*;
    use atomcad_structure_designer::text_format::TextFormatter;
...
mod auto_layout_tests {
    ...
    use atomcad_structure_designer::node_type::{NodeType, OutputPinDefinition};
    use atomcad_structure_designer::node_type_registry::NodeTypeRegistry;
    use atomcad_structure_designer::text_format::{auto_layout, edit_network};
    use glam::f64::DVec2;
...
mod persistent_node_names_phase6_tests {
    ...
    fn edit_designer_network(
        ...
        code: &str,
        replace: bool,
    ) -> atomcad_structure_designer::text_format::EditResult {
