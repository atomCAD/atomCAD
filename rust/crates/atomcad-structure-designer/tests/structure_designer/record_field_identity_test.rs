...
use atomcad_structure_designer::invariants::{InvariantKind, check_document_invariants};
...
fn recompute_next_field_id_raises_floor_but_never_lowers() {
    ...
    def.fields[0].id = atomcad_structure_designer::node_type_registry::FieldId(7);
    def.next_field_id = 0;
