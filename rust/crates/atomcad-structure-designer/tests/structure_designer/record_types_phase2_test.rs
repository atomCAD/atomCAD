...
use atomcad_structure_designer::undo::{UndoContext, UndoStack};
...
fn add_record_type_def_rejects_collision_with_node_network() {
    ...
    let net = NodeNetwork::new(NodeType {
        ...
        summary: None,
        category: atomcad_structure_designer::node_type::NodeTypeCategory::Custom,
        parameters: Vec::new(),
        output_pins: OutputPinDefinition::single(DataType::None),
        node_data_creator: || {
            Box::new(atomcad_structure_designer::node_data::CustomNodeData::default())
        },
        node_data_saver: atomcad_structure_designer::node_type::generic_node_data_saver::<
            atomcad_structure_designer::node_data::CustomNodeData,
        >,
        node_data_loader: atomcad_structure_designer::node_type::generic_node_data_loader::<
            atomcad_structure_designer::node_data::CustomNodeData,
        >,
        zone_input_pins: vec![],
...
fn build_designer_referencing(record_name: &str) -> StructureDesigner {
    use atomcad_structure_designer::node_type::Parameter;
    ...
    // wiring inside this test.
    {
        ...
        net.node_type.output_pins = vec![
            atomcad_structure_designer::node_type::OutputPinDefinition::fixed(
                "result",
                DataType::Array(Box::new(DataType::Record(RecordType::Named(
