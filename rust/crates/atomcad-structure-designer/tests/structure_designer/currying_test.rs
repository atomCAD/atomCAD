...
use atomcad_structure_designer::canonicalize::{
    canonicalize_network, canonicalize_record_type_defs,
};
use atomcad_structure_designer::data_type::{
...
use atomcad_structure_designer::evaluator::zone_closure::{ZoneClosure, run_closure_once};
use atomcad_structure_designer::node_data::{NoData, NodeData};
...
use atomcad_structure_designer::node_type::{NodeType, no_data_loader, no_data_saver};
...
fn canonicalize_network_flattens_closure_data_type_args() {
    ...
    let closure_data = ClosureData {
        kind: atomcad_structure_designer::nodes::closure::ClosureKind::Custom,
...
fn map_phase4_f_disconnect_restores_stored_output_type() {
    ...
    // Disconnect by selecting and deleting the f wire.
    {
        ...
        net.selected_wires
            .push(atomcad_structure_designer::node_network::Wire {
                source_node_id: g,
                source_pin: SourcePin::NodeOutput { pin_index: 0 },
                source_scope_depth: 0,
                ...
                destination_argument_kind:
                    atomcad_structure_designer::node_network::ArgumentKind::External,
            });
    }
