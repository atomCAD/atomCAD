...
use atomcad_structure_designer::nodes::atom_edit::diff_recorder::DiffRecorder;
...
fn coalesce_modified_modified() {
    use atomcad_structure_designer::nodes::atom_edit::diff_recorder::{AtomDelta, AtomState};
...
use atomcad_structure_designer::nodes::atom_edit::atom_edit::DragFrozenStatus;
use atomcad_structure_designer::nodes::atom_edit::atom_edit::drag_selected_by_delta;
use atomcad_structure_designer::nodes::atom_edit::atom_edit::transform_selected;
...
fn hybridization_override_migrated_on_base_atom_promotion() {
    ...
    {
        use atomcad_structure_designer::nodes::atom_edit::atom_edit::BaseAtomPromotionInfo;
        use atomcad_util::transform::Transform;
