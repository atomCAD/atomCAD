...
fn test_motif_edit_backward_compat_load() {
    ...
    let serializable: atomcad_structure_designer::serialization::atom_edit_data_serialization::SerializableAtomEditData =
...
fn test_cross_cell_bond_to_motif_basic() {
    ...
    // Convert to motif
    let motif = atomcad_structure_designer::nodes::atom_edit::atom_edit::atomic_structure_to_motif(
        &result,
        &uc,
        &data.parameter_elements,
