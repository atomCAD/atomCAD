...
use atomcad_structure_designer::text_format::edit_network as text_edit_network;
use atomcad_structure_designer::undo::{UndoCommand, UndoContext, UndoRefreshMode, UndoStack};
