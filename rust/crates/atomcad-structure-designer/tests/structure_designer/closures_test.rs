...
fn validation_type_incompatible_closure_into_f_rejected() {
    ...
    set_node_data(
        ...
        "main",
        filter_id,
        Box::new(atomcad_structure_designer::nodes::filter::FilterData {
            element_type: DataType::Int,
        }),
    );
    designer.connect_nodes(range_id, 0, filter_id, 0); // xs
...
fn custom_kind_closure_calculate_node_type_arity3() {
    use atomcad_structure_designer::data_type::FunctionType;
    use atomcad_structure_designer::node_type::NodeType;
    use atomcad_structure_designer::nodes::closure::get_node_type;
...
fn custom_kind_apply_calculate_node_type_arity2() {
    use atomcad_structure_designer::node_type::NodeType;
    use atomcad_structure_designer::nodes::apply::get_node_type;
