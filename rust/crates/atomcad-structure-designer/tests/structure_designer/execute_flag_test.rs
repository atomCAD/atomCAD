...
impl NodeData for CounterUnitNodeData {
    fn provide_gadget(
        &self,
        _structure_designer: &atomcad_structure_designer::structure_designer::StructureDesigner,
    ) -> Option<Box<dyn atomcad_structure_designer::node_network_gadget::NodeNetworkGadget>> {
        None
    }
