...
use atomcad_structure_designer::node_network::{NodeDisplayState, NodeDisplayType, NodeNetwork};
use atomcad_structure_designer::node_type::OutputPinDefinition;
...
fn test_node_type_output_type_accessor() {
    let registry = atomcad_structure_designer::node_type_registry::NodeTypeRegistry::new();
...
fn test_set_node_display_creates_default_display_state() {
    ...
    let node_id = network.add_node(
        ...
        glam::f64::DVec2::ZERO,
        1,
        Box::new(atomcad_structure_designer::node_data::NoData {}),
    );
...
fn test_node_scene_data_interactive_pin_empty() {
    use atomcad_structure_designer::structure_designer_scene::{NodeOutput, NodeSceneData};
...
fn test_motif_edit_output_pin_types_unchanged() {
    use atomcad_structure_designer::node_type::PinOutputType;
...
fn test_custom_network_shrink_disconnects_wires_inside_zone_body() {
    ...
    use atomcad_structure_designer::node_network::{IncomingWire, SourcePin};
...
mod resolve_output_type_tests {
    use atomcad_structure_designer::data_type::DataType;
    use atomcad_structure_designer::node_data::NoData;
    use atomcad_structure_designer::node_network::{Argument, Node, NodeNetwork};
    ...
    fn toy_node_type(
        ...
        NodeType {
            ...
            description: String::new(),
            summary: None,
            category: atomcad_structure_designer::node_type::NodeTypeCategory::OtherBuiltin,
            parameters,
            output_pins,
            zone_input_pins: vec![],
            zone_output_pins: vec![],
    ...
    fn make_node(id: u64, node_type_name: &str, arg_count: usize) -> Node {
        Node {
            ...
            body_width: atomcad_structure_designer::node_network::DEFAULT_BODY_WIDTH,
