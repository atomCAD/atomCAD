...
pub fn tessellate_circle_sheet(
    ...
    let center_index =
        output_mesh.add_vertex(Vertex::new(&center.as_vec3(), &normal.as_vec3(), material));
...
pub fn tessellate_sphere(
    ...
    let last_longitude_index_start =
        non_pole_index_start + (vertical_divisions - 2) * horizontal_divisions;
    for x in 0..horizontal_divisions {
        output_mesh.add_triangle(
            south_pole_index,
...
fn build_sphere_geometry(
    ...
    // Add north pole
    let north_pole_position =
        Vec3::new(center.x as f32, (center.y + radius) as f32, center.z as f32);
    let north_pole_normal = Vec3::new(0.0, 1.0, 0.0);
    let north_pole_index = occludable_mesh.add_vertex(OccludableVertex::new(
        north_pole_position,
        north_pole_normal,
        false,
    ));
    ...
    // Add south pole
    let south_pole_position =
        Vec3::new(center.x as f32, (center.y - radius) as f32, center.z as f32);
    let south_pole_normal = Vec3::new(0.0, -1.0, 0.0);
    let south_pole_index = occludable_mesh.add_vertex(OccludableVertex::new(
        south_pole_position,
        south_pole_normal,
        false,
    ));
...
fn mark_occlusion(occludable_mesh: &mut OccludableMesh, occluder_spheres: &[OccluderSphere]) {
    ...
    let triangle_centers: Vec<Vec3> = occludable_mesh
        .triangles()
        .iter()
        .map(|triangle| {
    ...
    for (triangle, center) in occludable_mesh
        .triangles_mut()
        .iter_mut()
        .zip(triangle_centers.iter())
    {
...
fn is_vertex_inside_occluder_spheres(
...
pub fn tessellate_cylinder(
    ...
    for x in 0..divisions {
        ...
        let bottom_position =
            center + rotation.mul_vec3(DVec3::new(0.0, -length * 0.5, 0.0) + normal * radius);
        let top_position =
            center + rotation.mul_vec3(DVec3::new(0.0, length * 0.5, 0.0) + normal * radius);
    ...
    if include_top_and_bottom {
        ...
        tessellate_circle_sheet(output_mesh, top_center, &up, radius, divisions, top_mat);
...
pub fn tessellate_grid(
    ...
    for x in 0..horiz_divisions {
        let cuboid_center = center
            + rotator.mul_vec3(DVec3::new(
                start_x + (x as f64) * grid_unit,
                -thickness * 0.5,
                0.0,
            ));
...
pub fn tessellate_cone(
    ...
    for x in 0..divisions {
        ...
        let apex_normal =
            (base_normals[x as usize] + base_normals[((x + 1) % divisions) as usize]) * 0.5;
        ...
        output_mesh.add_triangle(apex_index, current_base_index, next_base_index);
    }

    // Optionally create the base circle
    if include_base {
        tessellate_circle_sheet(output_mesh, base_center, &down, radius, divisions, material);
    }
}
...
pub fn tessellate_equilateral_triangle_prism(
    ...
    let bv0 = DVec3::new(
        prism_base_x + v0_rot_3d.x,
        prism_base_y + v0_rot_3d.y,
        -half_height,
    );
    let bv1 = DVec3::new(
        prism_base_x + v1_rot_3d.x,
        prism_base_y + v1_rot_3d.y,
        -half_height,
    );
    let bv2 = DVec3::new(
        prism_base_x + v2_rot_3d.x,
        prism_base_y + v2_rot_3d.y,
        -half_height,
    );
    ...
    let idx_bv0 = output_mesh.add_vertex(Vertex::new(
        &bv0.as_vec3(),
        &bottom_face_normal.as_vec3(),
        material,
    ));
    let idx_bv1 = output_mesh.add_vertex(Vertex::new(
        &bv1.as_vec3(),
        &bottom_face_normal.as_vec3(),
        material,
    ));
    let idx_bv2 = output_mesh.add_vertex(Vertex::new(
        &bv2.as_vec3(),
        &bottom_face_normal.as_vec3(),
        material,
    ));
    ...
    let idx_tv0 = output_mesh.add_vertex(Vertex::new(
        &tv0.as_vec3(),
        &top_face_normal.as_vec3(),
        material,
    ));
    let idx_tv1 = output_mesh.add_vertex(Vertex::new(
        &tv1.as_vec3(),
        &top_face_normal.as_vec3(),
        material,
    ));
    let idx_tv2 = output_mesh.add_vertex(Vertex::new(
        &tv2.as_vec3(),
        &top_face_normal.as_vec3(),
        material,
    ));
    ...
    let s_idx_bv0_01 = output_mesh.add_vertex(Vertex::new(
        &bv0.as_vec3(),
        &side01_normal.as_vec3(),
        material,
    ));
    let s_idx_bv1_01 = output_mesh.add_vertex(Vertex::new(
        &bv1.as_vec3(),
        &side01_normal.as_vec3(),
        material,
    ));
    let s_idx_tv1_01 = output_mesh.add_vertex(Vertex::new(
        &tv1.as_vec3(),
        &side01_normal.as_vec3(),
        material,
    ));
    let s_idx_tv0_01 = output_mesh.add_vertex(Vertex::new(
        &tv0.as_vec3(),
        &side01_normal.as_vec3(),
        material,
    ));
    ...
    let s_idx_bv1_12 = output_mesh.add_vertex(Vertex::new(
        &bv1.as_vec3(),
        &side12_normal.as_vec3(),
        material,
    ));
    let s_idx_bv2_12 = output_mesh.add_vertex(Vertex::new(
        &bv2.as_vec3(),
        &side12_normal.as_vec3(),
        material,
    ));
    let s_idx_tv2_12 = output_mesh.add_vertex(Vertex::new(
        &tv2.as_vec3(),
        &side12_normal.as_vec3(),
        material,
    ));
    let s_idx_tv1_12 = output_mesh.add_vertex(Vertex::new(
        &tv1.as_vec3(),
        &side12_normal.as_vec3(),
        material,
    ));
    ...
    let s_idx_bv2_20 = output_mesh.add_vertex(Vertex::new(
        &bv2.as_vec3(),
        &side20_normal.as_vec3(),
        material,
    ));
    let s_idx_bv0_20 = output_mesh.add_vertex(Vertex::new(
        &bv0.as_vec3(),
        &side20_normal.as_vec3(),
        material,
    ));
    let s_idx_tv0_20 = output_mesh.add_vertex(Vertex::new(
        &tv0.as_vec3(),
        &side20_normal.as_vec3(),
        material,
    ));
    let s_idx_tv2_20 = output_mesh.add_vertex(Vertex::new(
        &tv2.as_vec3(),
        &side20_normal.as_vec3(),
        material,
    ));
