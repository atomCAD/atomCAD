...
impl GPUMesh {
    ...
    pub fn new_empty_triangle_mesh(
        device: &Device,
        model_bind_group_layout: &wgpu::BindGroupLayout,
    ) -> Self {
    ...
    pub fn new_empty_atom_impostor_mesh(
        device: &Device,
        model_bind_group_layout: &wgpu::BindGroupLayout,
    ) -> Self {
    ...
    pub fn new_empty_bond_impostor_mesh(
        device: &Device,
        model_bind_group_layout: &wgpu::BindGroupLayout,
    ) -> Self {
    ...
    pub fn update_from_mesh(&mut self, device: &Device, mesh: &Mesh, label_prefix: &str) {
        assert!(
            ...
            "Cannot update a non-triangle GPUMesh with a triangle Mesh"
        );
    ...
    pub fn update_from_line_mesh(
        ...
        assert!(
            self.mesh_type == MeshType::Lines,
            "Cannot update a non-line GPUMesh with a LineMesh"
        );
    ...
    pub fn update_from_atom_impostor_mesh(
        &mut self,
        device: &Device,
        ...
        assert!(
            self.mesh_type == MeshType::AtomImpostors,
            "Cannot update a non-atom-impostor GPUMesh with an AtomImpostorMesh"
        );
    ...
    pub fn update_from_bond_impostor_mesh(
        &mut self,
        device: &Device,
        ...
        assert!(
            self.mesh_type == MeshType::BondImpostors,
            "Cannot update a non-bond-impostor GPUMesh with a BondImpostorMesh"
        );
