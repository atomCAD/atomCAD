...
fn default_samples_per_unit_cell() -> i32 { 1 }
fn default_sharpness_angle_threshold() -> f64 { 29.0 }
...
fn default_ball_and_stick_cull_depth() -> Option<f64> { Some(8.0) }
fn default_space_filling_cull_depth() -> Option<f64> { Some(3.0) }
...
fn default_background_color() -> APIIVec3 { APIIVec3 { x: 0, y: 0, z: 0 } }
fn default_show_grid() -> bool { true }
fn default_grid_size() -> i32 { 200 }
fn default_grid_color() -> APIIVec3 { APIIVec3 { x: 90, y: 90, z: 90 } }
fn default_grid_strong_color() -> APIIVec3 { APIIVec3 { x: 180, y: 180, z: 180 } }
fn default_show_lattice_axes() -> bool { true }
fn default_lattice_grid_color() -> APIIVec3 { APIIVec3 { x: 60, y: 90, z: 90 } }
fn default_lattice_grid_strong_color() -> APIIVec3 { APIIVec3 { x: 100, y: 150, z: 150 } }
fn default_drawing_plane_grid_color() -> APIIVec3 { APIIVec3 { x: 70, y: 70, z: 100 } }
fn default_drawing_plane_grid_strong_color() -> APIIVec3 { APIIVec3 { x: 110, y: 110, z: 160 } }
...
fn default_auto_layout_after_edit() -> bool { true }
