...
pub fn get_point_distance_to_ray(ray_origin: &DVec3, ray_direction: &DVec3, point: &DVec3) -> f64 {
...
pub fn cylinder_hit_test(
    ...
    if a < 1e-6 {
        ...
        return cylinder_caps_intersection(
            &local_ray_origin,
            &local_ray_direction,
            half_height,
            cylinder_radius,
    ...
    let t_caps = cylinder_caps_intersection(
        &local_ray_origin,
        &local_ray_direction,
        half_height,
        cylinder_radius,
