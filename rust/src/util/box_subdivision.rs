...
pub fn subdivide_box(
    ...
    let sub_size_x_first = if should_subdivide_x {
        size.x / 2
    } else {
        size.x
    };
    let sub_size_y_first = if should_subdivide_y {
        size.y / 2
    } else {
        size.y
    };
    let sub_size_z_first = if should_subdivide_z {
        size.z / 2
    } else {
        size.z
    };
    ...
    let sub_size_x_second = if should_subdivide_x {
        size.x - sub_size_x_first
    } else {
        size.x
    };
    let sub_size_y_second = if should_subdivide_y {
        size.y - sub_size_y_first
    } else {
        size.y
    };
    let sub_size_z_second = if should_subdivide_z {
        size.z - sub_size_z_first
    } else {
        size.z
    };
    ...
    for dx in 0..subdivisions_x {
        ...
        for dy in 0..subdivisions_y {
            ...
            for dz in 0..subdivisions_z {
                ...
                let sub_size = IVec3::new(sub_size_x, sub_size_y, sub_size_z);
...
pub fn subdivide_rect(
    ...
    for dx in 0..subdivisions_x {
        ...
        for dy in 0..subdivisions_y {
            ...
            let sub_start = IVec2::new(start_pos.x + offset_x, start_pos.y + offset_y);

            let sub_size = IVec2::new(sub_size_x, sub_size_y);
...
pub fn subdivide_box_float(
    ...
    let sub_size_x = if should_subdivide_x {
        size.x / 2.0
    } else {
        size.x
    };
    let sub_size_y = if should_subdivide_y {
        size.y / 2.0
    } else {
        size.y
    };
    let sub_size_z = if should_subdivide_z {
        size.z / 2.0
    } else {
        size.z
    };
    ...
    for dx in 0..subdivisions_x {
        ...
        for dy in 0..subdivisions_y {
            ...
            for dz in 0..subdivisions_z {
                ...
                let sub_size = DVec3::new(sub_size_x, sub_size_y, sub_size_z);
