...
use super::nodes::lattice_move::get_node_type_atom_lattice_move as atom_lattice_move_get_node_type;
use super::nodes::lattice_move::get_node_type_lattice_move as lattice_move_get_node_type;
use super::nodes::lattice_rot::get_node_type_atom_lattice_rot as atom_lattice_rot_get_node_type;
...
impl NodeTypeRegistry {
    pub fn new() -> Self {
        ...
        ret.add_node_type(atom_lattice_move_get_node_type());
        ret.add_node_type(atom_lattice_rot_get_node_type());
