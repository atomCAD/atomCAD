...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = -123224711;
...
fn pde_ffi_dispatcher_sync_impl(
    ...
    match func_id {
        ...
        14 => wire__crate__api__simple__get_cuboid_data_impl(ptr, rust_vec_len, data_len),
        15 => wire__crate__api__simple__get_geo_trans_data_impl(ptr, rust_vec_len, data_len),
        16 => wire__crate__api__simple__get_half_space_data_impl(ptr, rust_vec_len, data_len),
        17 => wire__crate__api__simple__get_node_network_view_impl(ptr, rust_vec_len, data_len),
        18 => wire__crate__api__simple__get_node_type_names_impl(ptr, rust_vec_len, data_len),
        19 => wire__crate__api__simple__get_scene_composer_view_impl(ptr, rust_vec_len, data_len),
        20 => {
            wire__crate__api__simple__get_selected_frame_transform_impl(ptr, rust_vec_len, data_len)
        }
        21 => wire__crate__api__simple__get_sphere_data_impl(ptr, rust_vec_len, data_len),
        22 => wire__crate__api__simple__greet_impl(ptr, rust_vec_len, data_len),
        23 => wire__crate__api__simple__import_xyz_impl(ptr, rust_vec_len, data_len),
        25 => wire__crate__api__simple__is_frame_locked_to_atoms_impl(ptr, rust_vec_len, data_len),
        26 => wire__crate__api__simple__move_camera_impl(ptr, rust_vec_len, data_len),
        27 => wire__crate__api__simple__move_node_impl(ptr, rust_vec_len, data_len),
        28 => wire__crate__api__simple__provide_texture_impl(ptr, rust_vec_len, data_len),
        29 => wire__crate__api__simple__rotate_around_local_axis_impl(ptr, rust_vec_len, data_len),
        30 => wire__crate__api__simple__select_align_atom_by_ray_impl(ptr, rust_vec_len, data_len),
