...
//! [`log`] crate for logging, and [`env_logger`] to read logging configuration from the environment
//! on desktop platforms.  To initialize these frameworks, this crate exposes a [`LoggingPlugin`]
//! type that can be instantiated and added to the applications [`app::App`].
//!
