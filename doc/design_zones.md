...
- The F→G conversion rule in `data_type.rs:378-414` (extras-as-prefix partial application) — partial application is now expressed as explicit boundary-crossing wires; the rule has no consumer.
