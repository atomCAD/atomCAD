...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  @override
  int get rustContentHash => 1507356368;
...
abstract class RustLibApi extends BaseApi {
  ...
  void crateApiStructureDesignerAtomEditApiAtomEditDrawBondByRay(
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  void crateApiStructureDesignerAtomEditApiAtomEditDrawBondByRay(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta:
          kCrateApiStructureDesignerAtomEditApiAtomEditDrawBondByRayConstMeta,
  ...
  TaskConstMeta
      get kCrateApiStructureDesignerAtomEditApiAtomEditDrawBondByRayConstMeta =>
          const TaskConstMeta(
            debugName: "atom_edit_draw_bond_by_ray",
  ...
  APIAtomEditData dco_decode_api_atom_edit_data(dynamic raw) {
    ...
    return APIAtomEditData(
      ...
      replacementAtomicNumber: dco_decode_opt_box_autoadd_i_16(arr[2]),
      addAtomToolAtomicNumber: dco_decode_opt_box_autoadd_i_16(arr[3]),
      hasSelectedAtoms: dco_decode_bool(arr[4]),
      hasSelection: dco_decode_bool(arr[5]),
      selectionTransform: dco_decode_opt_box_autoadd_api_transform(arr[6]),
      outputDiff: dco_decode_bool(arr[7]),
      showAnchorArrows: dco_decode_bool(arr[8]),
      includeBaseBondsInDiff: dco_decode_bool(arr[9]),
      showGadget: dco_decode_bool(arr[10]),
      diffStats: dco_decode_api_diff_stats(arr[11]),
    );
  }
