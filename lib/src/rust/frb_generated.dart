...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  @override
  int get rustContentHash => -641194799;
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  List<APICustomNodeParam>?
    ...
    return handler.executeSync(SyncTask(
      ...
      codec: SseCodec(
        decodeSuccessData: sse_decode_opt_list_api_custom_node_param,
        decodeErrorData: null,
      ),
      constMeta:
  ...
  List<APICustomNodeParam> dco_decode_list_api_custom_node_param(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return (raw as List<dynamic>)
        .map(dco_decode_api_custom_node_param)
        .toList();
  }
  ...
  List<APICustomNodeParam>? dco_decode_opt_list_api_custom_node_param(
      dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return raw == null ? null : dco_decode_list_api_custom_node_param(raw);
  }
  ...
  List<APICustomNodeParam> sse_decode_list_api_custom_node_param(
    ...
    var len_ = sse_decode_i_32(deserializer);
    var ans_ = <APICustomNodeParam>[];
    for (var idx_ = 0; idx_ < len_; ++idx_) {
      ans_.add(sse_decode_api_custom_node_param(deserializer));
    }
    return ans_;
  }
  ...
  List<APICustomNodeParam>? sse_decode_opt_list_api_custom_node_param(
    ...
    if (sse_decode_bool(deserializer)) {
      return (sse_decode_list_api_custom_node_param(deserializer));
    } else {
      return null;
    }
  }
  ...
  void sse_encode_list_api_custom_node_param(
    ...
    sse_encode_i_32(self.length, serializer);
    for (final item in self) {
      sse_encode_api_custom_node_param(item, serializer);
    }
  }
  ...
  void sse_encode_opt_list_api_custom_node_param(
    ...
    sse_encode_bool(self != null, serializer);
    if (self != null) {
      sse_encode_list_api_custom_node_param(self, serializer);
    }
  }
