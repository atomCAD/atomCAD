              ...
              return Builder(
                builder: (BuildContext itemContext) {
                  return GestureDetector(
                    onSecondaryTap: () {
                      print('Right-clicked on cluster ${cluster.id}');
                      ...
                      final RelativeRect position = RelativeRect.fromLTRB(
                        ...
                        screenSize.width - (offset.dx + itemSize.width), // Distance from right edge
                        screenSize.height - (offset.dy + itemSize.height), // Distance from bottom edge
                      );
                      
                      print('before showMenu');
